...
const WeatherInfo: React.FC<Props> = ({ preferredRegion, startDate, endDate }) => {
  ...
  const generateWeatherItems = useCallback(() => {
    ...
    for (var i = startIdx; i <= endIdx; i++) {
      ...
      items.push(
        <div className="flex flex-row  h-full w-32 mr-10 pt-10 items-center justify-center" key={i}>
            	<div className="flex flex-col w-32">
		               <label htmlFor="" className="block text-lg font-bold text-gray-900 mx-auto text-center">
